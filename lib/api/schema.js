...
import { validatePath } from "#core/naming-conventions";
import Module from "#lib/api/schema/module";
import { schemaValidator } from "#lib/api/schema/validator";
    ...
    loadSchema ( locations ) {
        ...
        for ( const module of Object.values( this.#modules ) ) {
            ...
            for ( const method of Object.values( module.methods ) ) {
                ...
                if ( this.#maxAttachmentContentLength < method.maxAttachmentContentLength ) {
                    this.#maxAttachmentContentLength = method.maxAttachmentContentLength;
                }
            }
        }
