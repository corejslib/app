...
export default Super =>
    class extends Super {
        ...
        // public
        async [ "API_get-user-notifications-profile" ] ( ctx, { "acl_id": aclId } = {} ) {
        ...
        async [ "API_set-user-notification-subscribed" ] ( ctx, { "acl_id": aclId, notification, channel, subscribed } = {} ) {
            if ( aclId ) {
        ...
        async [ "API_get-notifications-list" ] ( ctx, options ) {
