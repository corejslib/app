...
export default Super =>
    class extends Super {
        ...
        async [ "API_sign-up" ] ( ctx, email, { password, locale } = {} ) {
            ...
            // signup is disabled
            if ( !this.api.config.signupEnabled ) return result( [ 400, "Signup is disabled" ] );
            ...
            // email
                ...
                // signup with local email is not allowed
                if ( this.app.emailIsLocal( email ) ) return result( [ 400, "Email address domain is not valid" ] );
        ...
        async #getAppSettings () {
            if ( !this.#settings ) {
                ...
                this.#settings = {
                    ...
                    "allow_weak_passwords": this.app.users.config.allowWeakPasswords,
                    "allow_pwned_passwords": this.app.users.config.allowPwnedPasswords,
        ...
        async #sendNewSigninNotification ( userId, { userAgent, remoteAddress } ) {
            return this.app.notifications.sendNotification(
                ...
                l10nt( this.app.templates.get( "api/new-signin/body" ), {
                    "data": {
                        remoteAddress,
                        userAgent,
                    },
