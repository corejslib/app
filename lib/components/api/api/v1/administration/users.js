...
`;
        ...
        async [ "API_create-user" ] ( ctx, email, { password, enabled, roles } = {} ) {
        ...
        async [ "API_set-enabled" ] ( ctx, userId, enabled ) {
        ...
        async [ "API_set-password" ] ( ctx, userId, password ) {
        ...
        async [ "API_get-sessions" ] ( ctx, userId ) {
            return this.api.sessions.getSessions( userId, { "currentSessionId": ctx.token?.id } );
        }

        async [ "API_sign-out-session" ] ( ctx, userId, sessionId ) {
        ...
        async [ "API_sign-out-all-sessions" ] ( ctx, userId ) {
