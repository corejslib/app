...
export default Super =>
    class extends Super {
        ...
        // public
        async [ "API_get-methods" ] ( ctx, { period } ) {
            return this.dbh.select( SQL.getMethods, [ period, period ] );
        }

        async [ "API_get-monitoring-method-stats" ] ( ctx, monitoringMethodId, period ) {
            return this.dbh.select( SQL.getStats, [ period, STATS_PERIODS[ period ], monitoringMethodId ] );
        }

        async [ "API_get-method-exceptions-list" ] ( ctx, options = {} ) {
        ...
        async [ "API_clear-method-exceptions" ] ( ctx, monitoringMethodId ) {
