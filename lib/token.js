...
import { hashSync, randomFill } from "#core/crypto";
...
export default class Token {
    ...
    checkAuthorization ( remoteAddress, userAgent ) {
        ...
        if ( this.#lastAuthorized + this.app.api.authorizedSessionMaxAgeInterval.toMilliseconds().rounded.number < Date.now() ) return false;
